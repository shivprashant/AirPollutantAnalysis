# Addresses Question 5 of the assignment http://goo.gl/rzjpek
...
png(file="plot5.png", height=480, width=1000)

#Consider records where the EI.Sector contain Vehicals
#SubSet data for baltimore using fips of 24510 for baltimore.
NEI_SCC_VEHICALS_BALTI<-NEI_SCC[grepl("Vehicles", NEI_SCC$'EI.Sector') & (NEI_SCC$fips=='24510'),
...
qplot(year,Emissions,data=NEI_SCC_VEHICALS_BALTI, stat="summary", fun.y="sum", 
      ...
      main="Total Emissions from Vechical source for Baltimore City")
dev.off()